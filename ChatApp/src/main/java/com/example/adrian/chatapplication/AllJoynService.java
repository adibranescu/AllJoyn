...
public class AllJoynService extends Service implements Observer {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //          Android Service methods overriden
    ...
    public void onCreate() {
        ...
        // Create Background Thread that implements actions for events without blocking main thread
        startBusThread();
        mChatApplication = (ChatApplication)getApplication();
        // Register as Observer for ChatApplication events
        mChatApplication.addObserver(this);

        CharSequence title = "AllJoyn";
        CharSequence message = "Chat Channel Hosting Service.";

        // Probably useless try to send a notification to main activity that the service started
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //  Create Background Handler that implements actions for events without blocking main thread
     ...
     */
    private static final int HANDLE_HOST_START_CHANNEL_EVENT = 3;

    /**
     * Value for the HANDLE_HOST_STOP_CHANNEL_EVENT case observer notification handler.
     */
    private static final int HANDLE_HOST_STOP_CHANNEL_EVENT = 4;

    /**
     * Value for the HANDLE_OUTBOUND_CHANGED_EVENT case observer notification handler.
     */
    private static final int HANDLE_OUTBOUND_CHANGED_EVENT = 5;
    ///////////////////////////////////////////////////////////////////////////////////////////////

    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                      Handler for ChatApplication events
    ...
    /**
     * Enumeration of the states of the AllJoyn bus attachment.
     */
    ...
    /**
     * Commands handled by the background worker thread
     */
     ...
     * advertise.
     */
    private static final String NAME_PREFIX = "com.example.adrian.chatapplication";
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //          AllJoyn actions initiated by the background handler
    ...
    private void doJoinSession() {
        ...
        Status status = mBus.joinSession(wellKnownName, contactPort, sessionId, sessionOpts, new SessionListener() {
            ...
            public void sessionLost(int sessionId, int reason) {
                ...
                mChatApplication.alljoynError(ChatApplication.Module.USE, "The chat sessioWn has been lost");
     ...
     * handler names.
     */
    @BusSignalHandler(iface = "com.example.adrian.chatapplication", signal = "Chat")
